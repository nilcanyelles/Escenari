...
// Graella "Magic Bento" (partícules + glow + spotlight global) adaptada a
// Escenari: targetes amb dades reals en lloc del contingut de mostra.
...
const DEFAULT_GLOW_COLOR = "139, 123, 255"; // accent Escenari
...
function ParticleCard({
  ...
  }, [animateParticles, clearAllParticles, disableAnimations, enableTilt, enableMagnetism, enableStars, clickEffect, glowColor]);
      ...
      <div className="card-grid bento-section" ref={gridRef}>
        {cards.map(card => (
          ...
          >
            ...
            {card.content && <div className="magic-bento-card__body">{card.content}</div>}
