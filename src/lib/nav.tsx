export type PageKey = "agencia" | "grup" | "agenda" | "concerts" | "estadistiques" | "resum" | "calendari" | "grups" | "contactes" | "facturacio" | "basedades" | "suplencies" | "practica";

export type NavPage = { key: PageKey; href: string; label: string };

// Navegació principal de gestor: primer l'agència, després el grup, l'agenda
// (resum + calendari fusionats), els concerts i les estadístiques.
// Facturació, contactes i base de dades queden fora del menú (les rutes
// segueixen vives).
...
export const NAV_ICON_PATHS: Record<PageKey, string> = {
  agencia: '<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline>',
