// Port 1:1 de legacy/data.js (mateix generador de dades sintètiques) com a mòdul ESM,
// perquè el script de seed pugui importar-lo directament en lloc de reimplementar-lo.
...
var MONTH_WEIGHTS = [4, 3, 4, 4, 5, 9, 15, 18, 15, 5, 4, 4];
...
CONCERTS
  ...
  .forEach(function (c, idx) {
    ...
    var termDays = 90;
    if (idx % 11 === 0) termDays = 60;
    else if (idx % 13 === 0) termDays = 120;
...
export var APP_DATA = { BANDS: BANDS, CONCERTS: CONCERTS, INVOICES: INVOICES };
